...
const YearlyReviewEditor = () => {
  return (
    <div>
      <h4 className='text-primary text-center'>Yearly Review</h4>
      <hr />
      <div>
        ...
        <br />
        <hr />
        <h5 className='text-success pt-4'>Year Evaluation</h5>
        ...
        <br />
        <hr />
        <h5 className='text-success pt-4'>Next Year</h5>
        <div className='border border-secondary rounded pt-2 px-4'>
          <h6 className='text-info pb-2'>Next Year Plan</h6>
          <CKEditor
            editor={ClassicEditor}
            onInit={(editor) => {
              // You can store the "editor" and use when it is needed.
          ...
          <h6 className='text-info py-2'>Next Year Goals </h6>
          <CKEditor
            editor={ClassicEditor}
            onInit={(editor) => {
              // You can store the "editor" and use when it is needed.
...
export default YearlyReviewEditor;
